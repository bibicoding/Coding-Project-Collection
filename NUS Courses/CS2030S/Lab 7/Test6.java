...
/**
 * Test 6 for CS2030S Exercise 7 (AY24/25 Sem 2).  Tests
...
class Test6 {
  ...
  public static void main(String[] args) {
    ...
    i.expectReturn(
        ...
        () -> InfiniteList.<Integer>sentinel().reduce(0, (x, y) -> x + y),
        0);
    i.expectReturn(
        "InfiniteList.iterate(0, x -> x + 1).limit(5).reduce(0, (x, y) -> x + y)",
        () -> numbers.limit(5).reduce(0, (x, y) -> x + y),
        10);
    i.expectReturn(
    ...
    i.expectReturn("InfiniteList.sentinel().count()", () -> InfiniteList.sentinel().count(), 0L);
    i.expectReturn(
        "InfiniteList.iterate(0, x -> x + 1).limit(0).count()", () -> numbers.limit(0).count(), 0L);
    i.expectReturn(
        "InfiniteList.iterate(0, x -> x + 1).limit(1).count()", () -> numbers.limit(1).count(), 1L);
    i.expectReturn(
    ...
    i.expectReturn(
        ...
        () -> numbers.takeWhile(x -> x < 10).count(),
        10L);
    i.expectReturn(
