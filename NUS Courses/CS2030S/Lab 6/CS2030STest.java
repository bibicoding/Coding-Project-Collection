...
class CS2030STest {
  ...
  public <E extends Exception> CS2030STest expectCheckedException(
      String test, TryRunnable<E> task, E expectedE) {
    boolean gotException = false;
    try {
      task.run();
    } catch (Exception e) {
  ...
  public void expectCompileWithImport(
      String importStr, String test, String statement, boolean success) {
    System.out.print(test);
    ...
    boolean noError =
        ToolProvider.getSystemJavaCompiler()
            ...
            .getTask(null, null, null, null, null, List.of(new JavaSourceFromString(statement)))
            .call();
